...
| Field                     | Details                                                                  |
| ------------------------- | ------------------------------------------------------------------------ |
| Team Name                 | Leeds Space Communications Group                                         |
| Members                   | William Weller                                                           |
| Institution / Affiliation | University of Leeds                                                      |
| Contact Email             | m0xwi@proton.me                                                          |
| Repository URL            | [https://github.com/m0xwi/ccsds-sc2](https://github.com/m0xwi/ccsds-sc2) |
...
Mark each gateway as Complete, Partial, or Not Attempted. Provide a brief note for partial implementations.
...
| 6 — Hailing & Session Control   | [ ] Complete / [ ] Partial / [ ] Not Attempted |       |
...
| ----------------------------------------------- | --------- | ------------------------------- |
| Type F1 PLCW encodes/decodes correctly          |           | [test output or file reference] |
| Type F2 PLCW encodes/decodes correctly          |           |                                 |
| Variable-length SPDUs (Types 1–5) encode/decode |           |                                 |
...
| Check                                 | Pass/Fail | Evidence |
| ------------------------------------- | --------- | -------- |
| PhysicalChannel interface defined     |           |          |
...
| Check                                                                   | Pass/Fail | Evidence |
| ----------------------------------------------------------------------- | --------- | -------- |
| All states implemented (Init, Hailing, Data, Reconnecting, Termination) |           |          |
| Full Duplex state tables (Tables 5-1, 5-2)                              |           |          |
| Half Duplex state tables (Tables 5-1, 5-3)                              |           |          |
| Simplex state tables (Tables 5-1, 5-4)                                  |           |          |
...
| --- | ----------------------------------------------------------- | ------------- | -------- |
| 1   | Type F1 PLCW (V(R)=127, Retransmit=false, PCID=0, Exp=3)    | `[hex bytes]` | [ ]      |
| 2   | Type F2 PLCW (V(R)=500, Retransmit=true, PCID=1, Exp=6)     | `[hex bytes]` | [ ]      |
| 3   | Variable-Length SPDU (Type 1, SET V(R), SEQ_CTRL_FSN=42)    | `[hex bytes]` | [ ]      |
| 4   | P-frame (Version-3, containing artifact #1, Expedited QoS)  | `[hex bytes]` | [ ]      |
| 5   | U-frame (Version-3, payload 0x00–0x09, Seq Ctrl QoS, seq=7) | `[hex bytes]` | [ ]      |
...
| ------------ | ------------------------------------------ | ------------------- |
| [Team name]  | [e.g. Session established, data exchanged] | [Pass/Fail + notes] |
...
[Briefly summarise your Protocol Implementation Conformance Statement. Reference the full PICS document location in your repository.]
...
[Describe any additional features, optimisations, visualisations, or novel approaches your team implemented beyond the base requirements. E.g. state machine visualiser, session timeline viewer, etc.]
...
| ------------------------------ | ---------- | ------------- |
| Protocol Correctness (40)      | /40        |               |
| Testing & Conformance (25)     | /25        |               |
...
[Describe any exceptional work you believe merits bonus points: code quality, novel approaches, specification contributions, visualisation tools, etc.]
